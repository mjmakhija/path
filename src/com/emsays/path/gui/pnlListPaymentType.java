...
public class pnlListPaymentType extends javax.swing.JPanel implements MyPanelBack
{

	MyFormWrapper vParent;
	List<PaymentTypeDTO> vLstObjPaymentType;
	String[] vColumnNames =
	{
		"#",
		"Id",
	 ...
	 */
	public pnlListPaymentType(MyFormWrapper vParent)
	{
		initComponents();
	...
	private void mLoadData(List<PaymentTypeDTO> vLstObjPaymentType)
	{
		this.vLstObjPaymentType = vLstObjPaymentType;

		DefaultTableModel vDTM = new DefaultTableModel();
		vDTM.setColumnIdentifiers(vColumnNames);
		int i = 1;
		for (PaymentTypeDTO vObjPaymentType : vLstObjPaymentType)
		{
			Object[] o = new Object[]
			{
				i++,
				vObjPaymentType.getId(),
				vObjPaymentType.getName(),
				vObjPaymentType.getNote(),
			};
			vDTM.addRow(o);
		}
		tbl.setModel(vDTM);
	...
	{
		this.mLoadData(new PaymentTypeSer(Database.getSessionCompanyYear()).retrieve(txtName.getText()));
	}
	...
	private void handleClickBtnEdit()
	{
		...
		this.vParent.addPanel(new pnlAddPaymentType(vParent,this, vLstObjPaymentType.get(tbl.getSelectedRow())));
	...
	private void handleClickBtnDelete()
	{
		...
		else
		{
			...
			{
				PaymentTypeSer objPaymentTypeSer = new PaymentTypeSer(Database.getSessionCompanyYear());

				int[] vSelectedIndices = tbl.getSelectedRows();
				for (int i : vSelectedIndices)
				{
					objPaymentTypeSer.delete(vLstObjPaymentType.get(i));
				}
				//mLoadData();
