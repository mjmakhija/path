...
public class pnlAddArea extends javax.swing.JPanel
{
	...
	public pnlAddArea(MyFormWrapper vParent, MyPanelBack pnlBack)
	{
		initComponents();
	...
	public pnlAddArea(MyFormWrapper vParent, MyPanelBack pnlBack, AreaDTO vObjArea)
	{
		initComponents();
		this.frmWrapper = vParent;
		this.pnlBack = pnlBack;
		this.vModeAdd = false;
		this.parea = vObjArea;
		txtName.setText(vObjArea.getName());
		txtNote.setText(vObjArea.getNote());
	}
	...
	private void handleClickBtnSave()
	{
		...
		parea.setName(txtName.getText());
		parea.setNote(txtNote.getText());

		AreaSer pareaSer = new AreaSer(Database.getSessionCompanyYear());
		StringBuilder errorMsg = new StringBuilder();
		boolean result;

		if (vModeAdd)
		{
			result = (pareaSer.create(parea, errorMsg));
		}
		else
		{
			result = (pareaSer.update(parea, errorMsg));
		}

		if (result)
		{
			CommonUIActions.showMessageBox("Area saved successfully");
		}
		else
		{
