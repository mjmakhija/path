...
public class pnlListCollectFrom extends javax.swing.JPanel implements MyPanelBack
{

	MyFormWrapper vParent;
	List<CollectFromDTO> vLstObjCollectFrom;
	String[] vColumnNames =
	{
		"#",
		"Id",
	 ...
	 */
	public pnlListCollectFrom(MyFormWrapper vParent)
	{
		initComponents();
	...
	private void mLoadData(List<CollectFromDTO> vLstObjCollectFrom)
	{
		this.vLstObjCollectFrom = vLstObjCollectFrom;

		DefaultTableModel vDTM = new DefaultTableModel();
		vDTM.setColumnIdentifiers(vColumnNames);
		int i = 1;
		for (CollectFromDTO vObjCollectFrom : vLstObjCollectFrom)
		{
			Object[] o = new Object[]
			{
				i++,
				vObjCollectFrom.getId(),
				vObjCollectFrom.getName(),
				vObjCollectFrom.getNote(),
			};
			vDTM.addRow(o);
		}
		tbl.setModel(vDTM);
	...
	{
		this.mLoadData(new CollectFromSer(Database.getSessionCompanyYear()).retrieve(txtName.getText()));
	}
	...
	private void handleClickBtnEdit()
	{
		...
		this.vParent.addPanel(new pnlAddCollectFrom(vParent, this, vLstObjCollectFrom.get(tbl.getSelectedRow())));
	...
	private void handleClickBtnDelete()
	{
		...
		else
		{
			...
			{
				CollectFromSer objCollectFromSer = new CollectFromSer(Database.getSessionCompanyYear());

				int[] vSelectedIndices = tbl.getSelectedRows();
				for (int i : vSelectedIndices)
				{
					objCollectFromSer.delete(vLstObjCollectFrom.get(i));
				}
				//mLoadData();
