...
public class pnlListArea extends javax.swing.JPanel implements MyPanelBack
{

	MyFormWrapper vParent;
	List<AreaDTO> vLstObjArea;
	String[] vColumnNames =
	{
		"#",
		"Id",
	 ...
	 */
	public pnlListArea(MyFormWrapper vParent)
	{
		initComponents();
	...
	private void mLoadData(List<AreaDTO> vLstObjArea)
	{
		this.vLstObjArea = vLstObjArea;

		DefaultTableModel vDTM = new DefaultTableModel();
		vDTM.setColumnIdentifiers(vColumnNames);
		int i = 1;
		for (AreaDTO vObjArea : vLstObjArea)
		{
			Object[] o = new Object[]
			{
				i++,
	...
	{
		this.mLoadData(new AreaSer(Database.getSessionCompanyYear()).retrieve());
	}
	...
	private void handleClickBtnEdit()
	{
		...
		this.vParent.addPanel(new pnlAddArea(vParent, this, vLstObjArea.get(tbl.getSelectedRow())));
	...
	private void handleClickBtnDelete()
	{
		...
		else
		{
			...
			{
				AreaSer objAreaSer = new AreaSer(Database.getSessionCompanyYear());

				int[] vSelectedIndices = tbl.getSelectedRows();
				for (int i : vSelectedIndices)
				{
					objAreaSer.delete(vLstObjArea.get(i));
				}
				//mLoadData();
	...
	{
		vParent.addPanel(new pnlAddArea(vParent, this));
	}
	...
	@SuppressWarnings("unchecked")
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(layout.createSequentialGroup()
                                                                ...
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(btnMenu1, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        {//GEN-HEADEREND:event_btnMenu1ActionPerformed
		// TODO add your handling code here:
		mBtnAddClickHandler();
